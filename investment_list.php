...
if(isset($_GET['id'])){
    ...
    $data = single_condition_select("transections", "category", "investment");
}

while ($row = mysqli_fetch_array($data['query'])) {
    $id = $row['id'];
    $entry_date = date_format(date_create($row['entry_date']), "d-m-Y");
...
<div class="container mt-3">
    <h3 class="text-center mb-3" id="header_first">বিনিয়োগ</h3>
