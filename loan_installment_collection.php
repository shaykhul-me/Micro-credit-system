...
?>
<div class="mt-4">
    <h3 class="text-center">ঋন পরিশোধ</h3>
    <div id="showallmsg">
        <?php
                                        ...
                                        <div class="media-body">
                                            ...
                                            <p>
                                                ...
                                                <span>কিস্তি প্রতি আসল  : </span> <span id="actual_installment"></span> টাকা<br>
                                                 <span>কিস্তি প্রতি লাভ  : </span> <span id="profit_installment"></span> টাকা<br><br> 
...
// loan suggestion search
    ...
    $("#loan_no_search").autocomplete({
        ...
        select: function(event, ui) {
            ...
            $("#profit_installment").html(ui.item.data.profit_per_inatallment	);
