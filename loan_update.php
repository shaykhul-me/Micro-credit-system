...
if (isset($_POST["submit"])) {
           ...
           $edited = updatethis($updated_id_column, $array, $table_name);


            if (isset($edited['edited_id'])) {
                $staffid = $edited['edited_id'];
...
// data view 
$id =$_GET['loansoftid'];
$data = single_condition_select("loan_account", "id", "$id");
$count = $data['count'];
if($count == 1){
        ...
        <form method='post' action='' name='student_add' enctype="multipart/form-data">
            ...
            <div class="form-row">
               <!-- <div class="form-group col-md-2">
                ...
                <div class="form-group col-md-5">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Name" name='name' id="staffname" required value="<?php echo $row['name']; ?>">
                </div>
                <div class="form-group col-md-5">
                    <label for="name_bangla">নাম (বাংলা)</label>
                    <input type="text" class="form-control" placeholder="Enter Name (বাংলা)" name='name_bangla'" id="name_bangla" value="<?php echo $row['name_bn']; ?>">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Fathers Name" name="fname" value="<?php echo htmlspecialchars($row['father_name']); ?>">
                </div>
                <div class="form-group col-md-6">
                    <label for="name">মাতার নাম</label>
                    <input type="text" class="form-control" placeholder="Enter Mothers Name" name='mname' value="<?php echo htmlspecialchars($row['mother_name']); ?>">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Spause's Name" name='spause_name' id="spause_name" value="<?php echo htmlspecialchars($row['spouse_name']); ?>">
                </div>
                <div class="form-group col-md-6">
                    <label for="class">এন,আই,ডি/জন্ম নিবন্ধন<span style="color:red;">**</span></label>
                    <input type="text" class="form-control" placeholder="Enter National ID" name='nid' value="<?php echo htmlspecialchars($row['nid']); ?>">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="email" class="form-control" placeholder="Enter Email" name='email' value="<?php echo htmlspecialchars($row['email']); ?>">
                </div>
                <div class="form-group col-md-6">
                    ...
                    <div class="form-inline">
                        ...
                        <input class="form-control col-sm-11 col-10" name="mobile" type="text" size="11" placeholder="Enter Mobile Number" value="<?php echo htmlspecialchars($row['mobile']); ?>" required >
                    </div>
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="date" class="form-control" placeholder="Enter Date of Birth" name='dob' value="<?php echo htmlspecialchars($row['date_of_birth']); ?>">
                </div>
                <div class="form-group col-md-6">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Nominee Name" name='nominee_name' id="nominee_name" value="<?php echo htmlspecialchars($row['nominee_name']); ?>">
                </div>
                <div class="form-group col-md-6">
                    <label for="nominee_nid">নমিনীর এন,আই,ডি</label><span style="color:red;">**</span>
                    <input type="text" class="form-control" placeholder="Enter Nominee NID No" name='nominee_nid_no' id="nominee_nid_no" value="<?php echo htmlspecialchars($row['nominee_nid_no']); ?>">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Nominee Relation" name='nominee_relation' id="nominee_relation" value="<?php echo htmlspecialchars($row['nominee_relation']); ?>">
                </div>
                <div class="form-group col-md-6">
                    <label for="nominee_mobile">নমিনীর মোবাইল</label><span style="color:red;">**</span>
                    <input type="text" class="form-control" placeholder="Enter Nominee Mobile" name='nominee_mobile' id="nominee_mobile" value="<?php echo htmlspecialchars($row['nominee_mobile']); ?>">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-sm-4">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Present Address" name='present_address' id="present_address" value="<?php echo htmlspecialchars($row['present_address']); ?>">
                </div>
                <div class="form-group col-sm-4">
                    <label for="name">উপজেলা</label>
                    <input type="text" class="form-control" placeholder="Enter Present Upazila" name='present_upazila' id="present_upazila" value="<?php echo htmlspecialchars($row['present_thana']); ?>">
                </div>
                <div class="form-group col-sm-4">
                    <label for="name">জেলা</label>
                    <select name="present_district" id="present_district" class="form-control">
                        <option value="<?php echo htmlspecialchars($row['present_district']); ?>"><?php echo htmlspecialchars($row['present_district']); ?></option>
            ...
            <div class="form-row">
                <div class="form-group col-sm-4">
                    <label for="name">পাড়া/গ্রাম/পোষ্ট</label>
                    <input type="text" class="form-control" placeholder="Enter permanent Address" name='permanent_address' id="permanent_address" value="<?php echo htmlspecialchars($row['permanent_address']); ?>">
                </div>
                <div class="form-group col-sm-4">
                    <label for="name">উপজেলা</label>
                    <input type="text" class="form-control" placeholder="Enter permanent Upazila" name='permanent_upazila' id="permanent_upazila" value="<?php echo htmlspecialchars($row['permanent_thana']); ?>">
                </div>
                <div class="form-group col-sm-4">
                    <label for="name">জেলা</label>
                    <select name="permanent_district" id="permanent_district" class="form-control">
                        <option value="<?php echo htmlspecialchars($row['permanent_district']); ?>"><?php echo htmlspecialchars($row['permanent_district']); ?></option>
                        <option value="Barguna">Barguna</option>
                        <option value="Barishal">Barishal </option>
                        <option value="Bhola">Bhola </option>
                        <option value="Jhalokati">Jhalokati</option>
            ...
            $loan_items = option_collect("loan_type", $row['loan_type']);
            echo $loan_items['options'];
            ?>
                    </select>
                </div>
                ...
                <div class="form-group col-sm-4">
                    ...
                    <input type="number" class="form-control" placeholder=" loan_amount" name='product_price' id="product_price" value="<?php echo htmlspecialchars($row['product_price']); ?>">
                </div>
                <div class="form-group col-sm-4">
                    <label for="name">লাভের % </label>
                    <input type="number" class="form-control" placeholder="profit_percent" name="profit_percent" id="profit_percent" value="<?php echo htmlspecialchars($row['profit_percent']); ?>">
                </div>
                <div class="form-group col-sm-4">
                    <label for="name">লাভ </label>
                    <input type="number" class="form-control"  name='profit' id="profit" readonly value="<?php echo htmlspecialchars($row['profit']); ?>">
                </div>
                <div class="form-group col-sm-4">
                    <label for="name">মোট মূল্য </label>
                    <input type="number" class="form-control"  name="net_amount" id="net_amount" readonly value="<?php echo htmlspecialchars($row['net_amount']); ?>">
                </div>
                <div class="form-group col-sm-4">
                    <label for="name">কিস্তির পরিমান </label>
                    <input type="number" class="form-control" name="total_installment" id="total_installment" value="<?php echo htmlspecialchars($row['total_installment']); ?>">
                </div>
                <div class="form-group col-sm-4">
                    <label for="name">কিস্তি প্রতি টাকা </label>
                    <input type="number" class="form-control" name="taka_per_installment" id="taka_per_installment" readonly value="<?php echo htmlspecialchars($row['taka_per_installment']); ?>">
                </div>
                <div class="form-group col-sm-4">
                    <label for="name">কিস্তি প্রতি আসল </label>
                    <input type="number" class="form-control" name="actual_per_installment" id="actual_per_installment" readonly value="<?php echo htmlspecialchars($row['actual_per_installment']); ?>">
                </div>
                <div class="form-group col-sm-4">
                    <label for="name">কিস্তি প্রতি লাভ </label>
                    <input type="number" class="form-control" name="profit_per_inatallment" id="profit_per_inatallment" readonly value="<?php echo htmlspecialchars($row['profit_per_inatallment']); ?>">
                </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-4 mb-2 mt-3 border">
                    <label>মন্তব্য</label>
                    <textarea name="comment" cols="80" rows="5"><?php echo htmlspecialchars($row['comment']); ?></textarea>
