...
if (isset($_POST["submit"])) {
    // $mobile_ck_sql = single_condition_select("members", "mobile", $_POST['mobile']);
    
    $member_no_sql = double_condition_select("members", "member_no", $_POST['member_no'], "member_type", $_POST['member_type']);
    if ($_POST['member_no'] > 0) {
        if ($member_no_sql['count'] > 0) {
           
            echo "<div align='center' class='alert alert-danger' style='width:40%; font-size:20px; margin:0 auto;'>এই সদস্য আইডি পূর্বে ব্যবহৃত হয়েছে</div>";
        } else {
            $name =  $_POST['name'];
            ...
            if (isset($inserted['last_id'])) {
                ...
                // $actual_link = "index.php?action=mobile_verify&memberid=$staffid";
                // $actual_link = "index.php?action=member_insert";
                // $_SESSION['msg'] = "<div align='center' class='alert alert-success' style='width:40%; font-size:20px; margin:0 auto;'>সফল ভাবে নতুন মেম্বার তৈরী সম্পূর্ণ হয়েছে </div>";
                // echo "<script type='text/javascript'>location.href = '$actual_link';</script>";
                // exit;

                $form_success_message =  "submission('$default_redirect_url', 'Status', 'সফল ভাবে নতুন মেম্বার তৈরী সম্পূর্ণ হয়েছে')";
            } else {
                echo "<div align='center' class='alert alert-warning' style='width:40%; font-size:20px; margin:0 auto;'>Data did not Inserted</div>";
            }
            //     } else {
            //         echo "<div align='center' class='alert alert-danger' style='width:40%; font-size:20px; margin:0 auto;'>Staff Name Did Not Match</div>";
            //     }
            // } else {
            //     echo "<div align='center' class='alert alert-danger' style='width:40%; font-size:20px; margin:0 auto;'>Reference Staff Not Found</div>";
            // }
            // } else {
            //     echo "<div align='center' class='alert alert-danger' style='width:40%; font-size:20px; margin:0 auto;'>Please Select Correct Staff First</div>";
            // }
        }
    } else {
        echo "<div align='center' class='alert alert-danger' style='width:40%; font-size:20px; margin:0 auto;'>সদস্য আইডি সঠিক নয়</div>";
    }
}
    ...
    <div class="col-12">
        <form method='post' action='' name='student_add' enctype="multipart/form-data">
            <div class="text-center font-weight-bold font-weight-bolder">
                <h3 class="font-weight-bold font-weight-bolder text-capitalize">নতুন মেম্বার আবেদন ফরম</h3>
            </div><br>
            <div class="col-12">
            ...
            <div class="form-row">
                    ...
                    <input type="number" class="form-control" placeholder="Enter Name" name='member_no' id="member_no" required>
                </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Nominee NID" name='nominee_nid' id="nominee_nid">
                </div>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-3">
                    <label for="status">মেম্বারের ধরণ<span style="color:red;">**</span></label>
                 ...
                 <div class="form-group col-md-6">
                    <label for="name">শুরুর দিন </label>
                    <input type="date" class="form-control" placeholder="Enter Date of Birth" name='dob'>
                </div>
                <!-- <div class="form-group col-md-5">
                    <label for="reference">পরিচিত স্টাফ<span style="color:red;">**</span></label>
                    <input type="text" name="reference" class="form-control" required id="reference">
                    <input type="hidden" name="reference_id" id="reference_id">
                </div>
                <div class="form-group col-md-1">
                    <img src="assets/images/img/demo.jpg" id="staff_photo" width="80px" height="80px">
                </div> -->
            </div>
