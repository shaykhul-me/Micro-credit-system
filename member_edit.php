...
if (isset($_POST["submit"])) {
    ...
    $status = $conn->real_escape_string($_POST['status']);
     ...
     $member_no = $conn->real_escape_string($_POST['member_no']);
    ...
    $array  = array(
        ...
        "member_nid_front" => $m_nid_front,
        "member_nid_back" => $m_nid_back,
        "member_signature" => $m_signature,
        "m_nominee_img" => $nominee_photo,
        "m_nominee_nid_front" => $m_nominee_nid_front,
        "m_nominee_nid_back" => $m_nominee_nid_back,
    );
    $table_name = "members";
    $updated_id_column = array('id' => $id);
    ...
    if (isset($inserted['edited_id'])) {
        if ($user != '') {
            ...
            echo "<div align='center' class='alert alert-success' style='width:40%; font-size:20px; margin:0 auto;'>মেম্বারের সকল তথ্য সঠিকভাবে আপডেট করা হয়েছে</div>";
        }
    } else {
...
if ($row3 = mysqli_fetch_array($staff_info['query'])) {
    ...
    $reference_photo = $row3['staff_photo'];
}
?>
        ...
        <form method='post' action='' name='student_add' enctype="multipart/form-data" class="ignore_input">
            ...
            <div class="form-row">
                 ...
                 <div class="form-group col-md-2">
                    <label for="member_type">সদস্য ধরন</label>
                    <select class="form-control" id="member_type" name='member_type' required value="<?php echo isset($row['member_type']) ? $row['member_type'] : ""; ?>">
                         <option value="<?php echo isset($row['member_type']) ? $row['member_type'] : ""; ?>""><?php echo isset($row['member_type']) ? $row['member_type'] : ""; ?></option>
                        <option value="শিশু">শিশু</option>
                        <option value="পূর্ণ বয়স্ক">পূর্ণ বয়স্ক</option>
                    </select>
                    
                </div>
                
                    <div class="form-group col-md-2">
                    <label for="member_no">সদস্য নং<span style="color:red;">**</span></label>
                    <input type="number" class="form-control" placeholder="Enter Name" name='member_no' id="member_no" required value="<?php echo isset($row['member_no']) ? $row['member_no'] : ""; ?>">
                </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" placeholder="Enter National ID" name='nid' value="<?php echo isset($row['nid']) ? $row['nid'] : ""; ?>">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input id="email" type="email" class="form-control" placeholder="Enter Email" name='email' value="<?php echo isset($row['email']) ? $row['email'] : ""; ?>">
                </div>
                <div class="form-group col-md-6">
                    <label for="mobile">মোবাইল <span style="color:red;">**</span></label>
                    <input id="mobile" type="mobile" class="form-control" required placeholder="Enter Mobile" name='mobile' value="<?php echo isset($row['mobile']) ? $row['mobile'] : ""; ?>">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="name">নমিনীর সাথে সম্পর্ক</label><span style="color:red;">**</span>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-3">
                    <label for="class">    স্ট্যাটাস      <span style="color:red;">**</span></label>
                ...
                <div class="form-row">
                    <div class="form-group col-md-3 mb-2 border">
                        ...
                        <div class="text-center">
                            <img height='100px' class="photo_show modal_image_item pointer" src="<?php echo isset($row['member_photo']) && file_exists($row['member_photo']) ? $row['member_photo'] : "assets/images/img/demo.jpg"; ?>" alt="your image" id="member_img_show">
                        </div>
                    ...
                    <div class="form-group col-md-3 mb-2 border">
                        ...
                        <div class="text-center">
                            <img height='100px' class="photo_show modal_image_item pointer" src="<?php echo isset($row['member_nid_front']) && file_exists($row['member_nid_front']) ? $row['member_nid_front'] : "assets/img/nid_front.jpg"; ?>" alt="Member NID Front" id="m_nid_front_show">
                        </div>
                        <div class="custom-file">
                    ...
                    <div class="form-group col-md-3 mb-2 border">
                        ...
                        <div class="text-center">
                            <img height='100px' class="photo_show modal_image_item pointer" src="<?php echo isset($row['member_nid_back']) && file_exists($row['member_nid_back']) ? $row['member_nid_back'] : "assets/img/nid_back.jpg"; ?>" alt="Member NID Front" id="m_nid_back_show">
                        </div>
                    ...
                    <div class="form-group col-md-3 mb-2 border">
                        ...
                        <div class="text-center">
                            <img height='100px' class="photo_show modal_image_item pointer" src="<?php echo isset($row['member_signature']) && file_exists($row['member_signature']) ? $row['member_signature'] : "assets/images/img/sign.png"; ?>" alt="Member NID Front" id="m_signature_show">
                        </div>
                    ...
                    <div class="form-group col-md-3 mb-2 mt-3 border">
                        ...
                        <div class="text-center">
                            <img height='100px' src="<?php echo isset($row['m_nominee_img']) && file_exists($row['m_nominee_img']) ? $row['m_nominee_img'] : "assets/images/img/demo.jpg"; ?>" alt="Nominee Photo" id="nominee_photo_show" class="modal_image_item pointer">
                        </div>
                    ...
                    <div class="form-group col-md-3 mb-2 mt-3 border">
                        ...
                        <div class="text-center">
                            <img height='100px' class="photo_show modal_image_item pointer" src="<?php echo isset($row['m_nominee_nid_front']) && file_exists($row['m_nominee_nid_front']) ? $row['m_nominee_nid_front'] : "assets/img/nid_front.jpg"; ?>" alt="your image" id="nominee_nid_front_img_show">
                        </div>
                        <div class="custom-file">
                        ...
                        <input type="hidden" name="old_m_nominee_nid_front" value="<?php echo isset($row['m_nominee_nid_front']) ? $row['m_nominee_nid_front'] : ''; ?>">
                    </div>
                    <div class="form-group col-md-3 mb-2 mt-3 border">
                        <label for="nominee_nid_back">নমিনী এন,আই,ডি পিছনের অংশ</label>
                        <div class="text-center">
                            <img height='100px' class="photo_show modal_image_item pointer" src="<?php echo isset($row['m_nominee_nid_back']) && file_exists($row['m_nominee_nid_back']) ? $row['m_nominee_nid_back'] : "assets/img/nid_back.jpg"; ?>" alt="your image" id="nominee_nid_back_img_show">
                        </div>
                        <div class="custom-file">
                        ...
                        <input type="hidden" name="old_m_nominee_nid_back" value="<?php echo isset($row['m_nominee_nid_back']) ? $row['m_nominee_nid_back'] : ''; ?>">
                    </div>
                </div>
