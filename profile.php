    <?php
    $userinfo = single_post_view("users", $uid);
    if ($row = mysqli_fetch_array($userinfo['query'])) {
        $account_area = $row['ac_area'];
        $account_id = $row['ac_id'];
        $updatetime = $row['updatetime'];
    }
    if ($account_area == "staff" && $account_id > 0) {

        if ($userdetails = single_post_view("staffs", $account_id)) {
            if ($row = mysqli_fetch_array($userdetails['query'])) {
                $name = $row['name'];
            ...
            <div class="col-lg-3 col-md-4">
                <div class="ibox">
                    <div class="ibox-body text-center">
                        <div class="m-t-20">
                            <img class="img-circle" src="<?php echo isset($photo) && file_exists($photo) ? $photo : 'assets/img/admin-avatar.png'; ?>" height="150px" />
                        </div>
                        <h5 class="font-strong m-b-10 m-t-10"><?php echo isset($name) ? $name : ""; ?></h5>
                        <div class="m-b-20 text-muted"><?php echo isset($ac_type) ? $ac_type : ""; ?></div>
                ...
                <div class="ibox">
                    <div class="ibox-body">
                        <ul class="nav nav-tabs tabs-line">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="#tab-2" data-toggle="tab"><i class="ti-settings"></i> Information</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade show active" id="tab-2">
                                <form action="javascript:void(0)">
                                    <div class="row">
                                        <div class="col-sm-3 font-bold">Father's Name</div>
                                        <div class="col-sm-9"><?php echo isset($fname) ? $fname : ""; ?></div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        <div class="col-sm-3 font-bold">Mother's Name</div>
                                        <div class="col-sm-9"><?php echo isset($mname) ? $mname : ""; ?></div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        <div class="col-sm-3 font-bold">Email</div>
                                        <div class="col-sm-9"><?php echo isset($email) ? $email : ""; ?></div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        <div class="col-sm-3 font-bold">Mobile</div>
                                        <div class="col-sm-9"><?php echo isset($mobile) ? $mobile : ""; ?></div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        <div class="col-sm-3 font-bold">Last Updated</div>
                                        <div class="col-sm-9"><?php echo isset($updatetime) ? $updatetime : ""; ?></div>
                                    </div>
                                    <hr>
                                </form>
                            </div>
