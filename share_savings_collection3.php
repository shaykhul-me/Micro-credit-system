...
if (isset($_POST['new_transection'])) {
    ...
    if ($savings_installment_total > 0) {
        ...
        $check_savings_last_transect = manual_query("SELECT * FROM transections_details WHERE account_id='{$check_savings_ac_res['id']}' AND month_name !='' ORDER BY id DESC LIMIT 1");
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="member_number_search" id="member_number_search" required>
                        </div>
                    </div>
                    <div class="col-md-8">
                        <div class="form-group">
