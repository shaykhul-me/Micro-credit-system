        ...
        <div class="col-lg-3 col-md-4">
            <div class="ibox">
                <div class="ibox-body text-center">
                    <div class="m-t-20">
                        <img class="img-circle" src="<?php echo isset($row['staff_photo']) && file_exists($row['staff_photo']) ? $row['staff_photo'] : 'assets/images/img/demo.jpg'; ?>" height="150px" />
                    </div>
                    <h5 class="font-strong m-b-10 m-t-10"><?php echo isset($row['name']) ? $row['name'] : "";
                                                            echo isset($row['name_bn']) ? "<br>" . $row['name_bn'] : ""; ?></h5>
                    <div class="m-b-20 text-info"><?php echo isset($row['position']) ? $staff_desig_array[$row['position']] : "";?></div>
                    ...
                    <hr>
                    <div class="text-left">
                        <div class="font-bold">Office : <?php echo isset($row['office']) ? $row['office'] : ""; ?></div>
                    </div>
                    <?php
                    }
                    if($row['branch'] != ""){
                    ...
                    <hr>
                    <div class="text-left">
                        <div class="font-bold">Branch : <?php echo isset($row['branch']) ? $row['branch'] : ""; ?></div>
                    </div>
                    <?php
                    }
                    ?>
                ...
                <div class="ibox-body">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade" id="member_files">
                            <div class="row">
                                <div class="col-sm-3 font-bold">Staff's NID</div>
                                <div class="col-sm-9">
                                    <img height="100px" class="mb-2" src="<?php echo isset($row['staff_nid_front']) && file_exists($row['staff_nid_front']) ? $row['staff_nid_front'] : "assets/img/nid_front.jpg"; ?>" alt="Member NID Front" srcset="">&nbsp;&nbsp;<img height="100px" class="mb-2" src="<?php echo isset($row['staff_nid_back']) && file_exists($row['staff_nid_back']) ? $row['staff_nid_back'] : "assets/img/nid_back.jpg"; ?>" alt="Member NID Back" srcset="">
                            </div>
                            </div>
                            <hr>
                            <div class="row">
                                <div class="col-sm-3 font-bold">Staff's Signature</div>
                                <div class="col-sm-9">
                                    <img height="100px" class="mb-2" src="<?php echo isset($row['	staff_signature']) && file_exists($row['	staff_signature']) ? $row['	staff_signature'] : "assets/images/img/sign.png"; ?>" alt="Member NID Back" srcset="">
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                <div class="col-sm-3 font-bold">Nominee Image</div>
                                <div class="col-sm-9"><img height="100px" class="mb-2" src="<?php echo isset($row['s_nominee_img']) && file_exists($row['s_nominee_img']) ? $row['s_nominee_img'] : "assets/images/img/demo.jpg"; ?>" alt="Member NID Back" srcset=""></div>
                            </div>
                            <hr>
                            <div class="row">
                                <div class="col-sm-3 font-bold">Nominee NID Front, Back</div>
                                <div class="col-sm-9"><img height="100px" class="mb-2" src="<?php echo isset($row['s_nominee_nid_front']) && file_exists($row['s_nominee_nid_front']) ? $row['s_nominee_nid_front'] : "assets/img/nid_front.jpg"; ?>" alt="Nominee NID Front" srcset="">&nbsp;&nbsp;<img height="100px" class="mb-2" src="<?php echo isset($row['s_nominee_nid_back']) && file_exists($row['s_nominee_nid_back']) ? $row['s_nominee_nid_back'] : "assets/img/nid_back.jpg"; ?>" alt="Member NID Front" srcset=""></div>
                            </div>
                            <hr>
                        </div>
